...
export const EditVendor = loadable(() => import('./MassEnergizeSuperAdmin/Vendors/EditVendor'), {
  fallback: <Loading />,
});
...
export const ImportContacts = loadable(() => import('./MassEnergizeSuperAdmin/Summary/ImportContacts'), {
  fallback: <Loading />,
});
