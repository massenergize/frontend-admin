...
class AllActions extends React.Component {
  ...
  renderTable = (data, classes) => (
    <PapperBlock noMargin title="All Actions" icon="ios-share-outline" whiteBg desc="">
  ...
  render() {
    ...
    return (
      ...
      <div>
        ...
        <PapperBlock title="All Actions" desc="Some text description">
          {/* {this.renderTable(actions, classes)} */}
          Hello
        </PapperBlock>
      </div>
    );
