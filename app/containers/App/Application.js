...
class Application extends React.Component {
  ...
  render() {
    ...
    const user = auth || {};
    const routeDoesNotRequireDashboard = routesWithNoDashboardView.includes(currentURL);
        ...
        {routeDoesNotRequireDashboard ? (
          ...
          <Dashboard history={history} changeMode={changeMode} lock={!IS_LOCAL && auth?.needs_to_accept_mou}>
            ...
            <ThemeToast
              ...
              onClose={() => {
                toggleUniversalToast({ open: false, show: false, component: null });
                return false;
              }}
            ...
            <Switch>
              ...
              <Route path="/admin/read/community-admin-messages" exact component={CommunityAdminMessages} />
              <Route path="/admin/read/team-admin-messages" exact component={TeamAdminMessages} />
              <Route path="/admin/edit/:id/message" exact component={MessageDetails} />
              <Route path="/admin/send/message" exact component={SendMessage} />
              <Route path="/admin/edit/:id/scheduled-message" exact component={SendMessage} />
              <Route path="/admin/scheduled/messages" exact component={ScheduledMessages} />
              ...
              <Route path="/admin/read/testimonials/testimonial-sharing" exact component={TestimonialsFromOthers} />
              ...
              <Route path="/admin/read/action-engagements" component={ActionEngagementList} />
