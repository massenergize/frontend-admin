...
import TranslationLanguagesPerCommunity from "../MassEnergizeSuperAdmin/Pages/TranslationLanguagesPerCommunity";
      ...
      >
        <Dashboard history={history} changeMode={changeMode} lock={!IS_LOCAL && auth?.needs_to_accept_mou}>
          ...
          <Switch>
            ...
            <Route
              path="/admin/community/configure/language-translation"
              component={TranslationLanguagesPerCommunity}
            />
